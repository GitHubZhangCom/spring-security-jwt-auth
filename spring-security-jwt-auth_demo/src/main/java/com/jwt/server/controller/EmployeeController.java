...
/**
 * Created with IntelliJ IDEA. Date: 2017/11/16 Time: 10:32 Email:
 * hyf_spring@163.com
 *
 * @author huyunfan
 */
...
public class EmployeeController {
	...
	@ResponseBody
	public JSONObject login(@RequestBody Employee employee, HttpServletResponse response) {
		...
		String subject = employee.getUsername() + "-" + roleList;
		...
		jsonpObject.put("username", employee.getUsername());
